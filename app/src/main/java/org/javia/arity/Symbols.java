...
public class Symbols {
  ...
  private Hashtable<Symbol, Symbol> symbols = new Hashtable<>(); // Hashtable<Symbol, Symbol>
  ...
  private static final String defines[] = { "log(x)=ln(x)*0.43429448190325182765", // log10(e)
